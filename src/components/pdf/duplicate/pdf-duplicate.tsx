...
export default function PDF({ recieve }: Props) {
  const hasRecharge = recieve.recharge;
  const rechargeAmount = hasRecharge ? recieve.amount / 10 : 0;
  const amountWithRecharge = hasRecharge ? recieve.total : recieve.amount;
  const cantidad = hasRecharge ? 1 : 0;
      ...
      <Page size="A4" style={styles.page}>
        <View style={styles.wrap}>
          <View style={styles.header}>
            ...
            <View style={styles.subheader}>
              <Text style={styles.original}>DUPLICADO</Text>
          ...
          <View>
            <View style={styles.body}>
              <View style={styles.tablesection}>
                ...
                <Text>Recargo por retraso en el pago(10%)</Text>
              </View>
              <View style={styles.tablesection}>
                <Text
                  style={{
